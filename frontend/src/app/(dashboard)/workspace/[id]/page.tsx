      ...
      <div style={{ padding: "12px 24px", borderBottom: "1px solid var(--border-default)", background: "var(--bg-surface)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "6px", color: "var(--text-tertiary)", fontSize: "0.8rem" }}>
          {(() => {
            ...
            return (
              <>
                <Clock size={14} /> Submitted: {new Date(submittedStr).toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})}
              </>
            );
          })()}
        </div>
          ...
          <div className="card" style={{ padding: "0", overflow: "hidden" }}>
            ...
            <div style={{ padding: "20px" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
                {d.labs && Object.keys(parseClinicalSummaryForLabs(d.clinical_summary, d.labs)).length > 0 ? Object.entries(parseClinicalSummaryForLabs(d.clinical_summary, d.labs)).map(([key, val]) => {
